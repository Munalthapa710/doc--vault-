...
public class OtpService(MongoContext context, IEmailService emailService, IAuditLogService auditLogService, IOptions<SecuritySettings> options) : IOtpService
{
